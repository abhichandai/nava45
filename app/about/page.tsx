      ...
      <section className="case-body-section" style={{ background: 'var(--bg)' }}>
        <div className="case-body-inner">
          ...
          <style>{`
            ...
            .team-hover-overlay { position: absolute; bottom: 0; left: 0; right: 0; padding: 20px; opacity: 0; transform: translateY(10px); transition: opacity 0.35s ease, transform 0.35s ease; pointer-events: none; }
